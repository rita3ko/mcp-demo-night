/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3d7a3e220b9e7514b49bc73222561efe)
// Runtime types generated with workerd@1.20251202.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MCPChatAgent" | "CodemodeChatAgent";
	}
	interface Env {
		...
		MCP_CHAT_AGENT: DurableObjectNamespace<import("./src/index").MCPChatAgent>;
		CODEMODE_CHAT_AGENT: DurableObjectNamespace<import("./src/index").CodemodeChatAgent>;
	}
}
